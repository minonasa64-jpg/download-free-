...
class BackendService {
  ...
  String t(String key) {
    final ar = {
      ...
      'storage_maintenance': 'التخزين والصيانة',
      'turbo_download': 'التحميل المتسارع (Turbo Multi-Threading)',
      'turbo_download_desc': 'تنزيل الملفات عبر عدة اتصالات متزامنة لمضاعفة سرعة التحميل',
      'threads_count': 'عدد مسارات التنزيل المتزامنة',
      'threads_desc': 'مسارات متزامنة للتحميل فائق السرعة',
      'download_path_title': 'مسار حفظ التنزيلات',
      'auto_retry_desc': 'استئناف التحميل تلقائياً عند انقطاع الاتصال',
      'clear_cache_title': 'تنظيف الملفات المؤقتة والكاش',
      'clear_cache_desc': 'حذف أجزاء التنزيل غير المكتملة (.part) وتحرير مساحة التخزين',
      'web_share_desc': 'مشاركة الملفات وتنزيلها مباشرة إلى الكمبيوتر بدون كابل عبر المتصفح',
      'change_vault_pin': 'تغيير رمز PIN للخزنة',
      'change_vault_pin_desc': 'تعيين رمز حماية سري جديد للخزنة',
      'biometric_title': 'فتح الخزنة بالبصمة (Biometrics)',
    ...
    final en = {
      ...
      'turbo_download': 'Turbo Multi-Threading Download',
      'turbo_download_desc': 'Download files via parallel connections to maximize speed',
      'threads_count': 'Concurrent Download Threads',
      'threads_desc': 'parallel threads for ultra-fast downloads',
      'download_path_title': 'Downloads Save Path',
      'auto_retry_desc': 'Automatically resume downloads upon reconnection',
      'clear_cache_title': 'Clean Temporary Cache & Files',
      'clear_cache_desc': 'Delete unfinished download parts (.part) to free up space',
      'web_share_desc': 'Share and download files directly to PC via browser without cable',
      'change_vault_pin': 'Change Vault PIN',
      'change_vault_pin_desc': 'Set a new secure PIN code for the vault',
      'biometric_title': 'Unlock Vault with Biometrics',
    ...
    final fr = {
      ...
      'storage_maintenance': 'Stockage et Maintenance',
      'turbo_download': 'Téléchargement Turbo Multi-Fils',
      'turbo_download_desc': 'Télécharger via plusieurs connexions pour maximiser la vitesse',
      'threads_count': 'Fils de téléchargement simultanés',
      'threads_desc': 'fils simultanés pour un débit ultra-rapide',
      'download_path_title': 'Dossier de stockage',
      'auto_retry_desc': 'Reprendre automatiquement après reconnexion',
      'clear_cache_title': 'Nettoyer le cache et les fichiers temporaires',
      'clear_cache_desc': 'Supprimer les fichiers .part inachevés pour libérer l\'espace',
      'web_share_desc': 'Partager et télécharger des fichiers directement sur PC via navigateur',
      'change_vault_pin': 'Changer le code PIN du coffre',
      'change_vault_pin_desc': 'Définir un nouveau code PIN sécurisé',
    ...
    final es = {
      ...
      'search': 'Buscar', 'discover': 'Descubrir y Descargar', 'search_hint': 'Buscar en YouTube...',
      'start_search': 'Busca videos o audios en alta calidad fácilmente',
      'download_btn': 'Descargar', 'related': 'Videos relacionados',
      'have_link': '¿Tienes un enlace?', 'paste_here': 'Pega el enlace aquí para descargar',
      'downloading': 'Descargando...', 'completed': 'Descarga completada',
      'formats_title': 'Seleccionar calidad', 'video': 'Videos', 'audio': 'Música',
      'downloaded': 'Archivos descargados', 'general': 'General', 'dl_settings': 'Ajustes de descarga',
      'notif': 'Notificaciones', 'theme': 'Tema', 'language': 'Idioma', 'more_tools': 'Más herramientas',
      'share_app': 'Compartir app', 'clean_cache': 'Limpiar caché', 'about': 'Acerca de',
      'no_audio': 'No hay música descargada', 'no_video': 'No hay videos descargados',
      'downloading_now': 'Descargando:', 'file_not_found': 'Archivo no encontrado',
      'no_results': 'Sin resultados 😔', 'search_error': 'Error de búsqueda.',
      'invalid_link': 'Enlace inválido', 'extracting': 'Extrayendo formatos...',
      'share': 'Compartir', 'convert_to_mp3': 'Convertir a MP3', 'converting': 'Extrayendo audio...',
      'converted_success': '¡Audio extraído con éxito!', 'convert_failed': 'Error al extraer audio', 'size': 'Tamaño',
      'vault': 'Cofre privado', 'vault_desc': 'Proteger archivos con código PIN',
      'set_pin': 'Definir PIN', 'enter_pin': 'Introduce tu PIN',
      'pin_hint': 'Código de 4 dígitos', 'pin_set_success': 'PIN guardado correctamente',
      'wrong_pin': '¡PIN incorrecto!', 'move_to_vault': 'Bloquear en el cofre',
      'moved_to_vault_success': 'Archivo movido al cofre 🔒',
      'restore_from_vault': 'Desbloquear (Restaurar)',
      'restored_success': 'Archivo restaurado 🔓',
      'vault_empty': 'El cofre está vacío.',
      'wifi_only': 'Solo descargar con Wi-Fi', 'wifi_only_desc': 'Ahorrar datos móviles',
      'wifi_warning': 'Descarga en pausa: Solo Wi-Fi activado',
      'auto_retry_active': 'Reanudación automática activa', 'retrying_download': 'Reintentando...',
      'web_share': 'Compartir por Wi-Fi a PC', 'audio_trimmer': 'Cortador de audio y tonos', 'calculator_disguise': 'Disfraz de calculadora', 'calculator_disguise_desc': 'Mostrar calculadora real desbloqueada con PIN', 'subtitles': 'Subtítulos (SRT)', 'download_subtitles': 'Descargar subtítulo', 'playlist': 'Lista de reproducción', 'download_all_video': 'Descargar todo en Video (MP4)', 'download_all_audio': 'Descargar todo en Audio (MP3)', 'schedule_download': 'Programar descarga', 'quick_platforms': 'Plataformas rápidas', 'clipboard_detected': '¡Enlace detectado en el portapapeles!', 'browser': 'Navegador', 'biometric_auth': 'Biometría', 'biometric_desc': 'Desbloquear cofre con huella o rostro',
      'theme_station': 'Estación de Temas', 'theme_station_desc': 'Cambiar apariencia y colores',
      'data_usage': 'Estadísticas de datos', 'data_usage_desc': 'Supervisar consumo de red',
      'today_usage': 'Consumo de hoy', 'total_usage': 'Consumo total', 'saved_data': 'Datos ahorrados',
      'decoy_pin': 'PIN de cofre falso (Decoy)', 'decoy_pin_desc': 'PIN alternativo que abre un cofre vacío de señuelo',
      'vault_settings': 'Seguridad del cofre',
      'privacy_security': 'Privacidad y Seguridad',
      'storage_maintenance': 'Almacenamiento y Mantenimiento',
      'turbo_download': 'Descarga Turbo Multihilo',
      'turbo_download_desc': 'Descarga mediante múltiples conexiones paralelas',
      'threads_count': 'Hilos de descarga simultáneos',
      'threads_desc': 'hilos simultáneos para máxima velocidad',
      'download_path_title': 'Ruta de almacenamiento',
      'auto_retry_desc': 'Reanudar automáticamente al reconectar',
      'clear_cache_title': 'Limpiar archivos temporales y caché',
      'clear_cache_desc': 'Eliminar partes incompletas (.part) para liberar espacio',
      'web_share_desc': 'Compartir y descargar archivos directamente a tu PC sin cables',
      'change_vault_pin': 'Cambiar PIN del cofre',
      'change_vault_pin_desc': 'Establecer un nuevo código PIN seguro',
      'biometric_title': 'Desbloqueo biométrico',
    ...
    final tr = {
      ...
      'search': 'Ara', 'discover': 'Keşfet ve İndir', 'search_hint': 'YouTube\'da ara...',
      'start_search': 'Yüksek kalitede video veya ses bulun',
      'download_btn': 'İndir', 'related': 'Benzer Videolar',
      'have_link': 'Bağlantınız var mı?', 'paste_here': 'İndirmek için bağlantıyı buraya yapıştırın',
      'downloading': 'İndiriliyor...', 'completed': 'İndirme Tamamlandı',
      'formats_title': 'Kalite Seçin', 'video': 'Videolar', 'audio': 'Müzik',
      'downloaded': 'İndirilen Dosyalar', 'general': 'Genel', 'dl_settings': 'İndirme Ayarları',
      'notif': 'Bildirimler', 'theme': 'Tema', 'language': 'Dil', 'more_tools': 'Daha Fazla Araç',
      'share_app': 'Uygulamayı Paylaş', 'clean_cache': 'Önbelleği Temizle', 'about': 'Hakkında',
      'no_audio': 'İndirilen müzik yok', 'no_video': 'İndirilen video yok',
      'downloading_now': 'İndiriliyor:', 'file_not_found': 'Dosya bulunamadı',
      'no_results': 'Sonuç bulunamadı 😔', 'search_error': 'Arama hatası.',
      'invalid_link': 'Geçersiz bağlantı', 'extracting': 'Formatlar çıkarılıyor...',
      'share': 'Paylaş', 'convert_to_mp3': 'MP3\'e Dönüştür', 'converting': 'Ses çıkarılıyor...',
      'converted_success': 'Ses başarıyla çıkarıldı!', 'convert_failed': 'Ses çıkarma başarısız', 'size': 'Boyut',
      'vault': 'Gizli Kasa', 'vault_desc': 'Medyayı PIN kodu ile koruyun',
      'set_pin': 'PIN Belirle', 'enter_pin': 'PIN Kodunu Girin',
      'pin_hint': '4 haneli kod', 'pin_set_success': 'PIN başarıyla ayarlandı',
      'wrong_pin': 'Hatalı PIN!', 'move_to_vault': 'Kasaya Kilitle',
      'moved_to_vault_success': 'Dosya kasaya taşındı 🔒',
      'restore_from_vault': 'Kilidi Aç (İndirilenlere Geri Yükle)',
      'restored_success': 'Dosya geri yüklendi 🔓',
      'vault_empty': 'Kasa şu anda boş.',
      'wifi_only': 'Yalnızca Wi-Fi ile İndir', 'wifi_only_desc': 'Mobil veriden tasarruf edin',
      'wifi_warning': 'İndirme duraklatıldı: Yalnızca Wi-Fi etkin',
      'auto_retry_active': 'Otomatik devam etme aktif', 'retrying_download': 'Yeniden deneniyor...',
      'web_share': 'PC ile Wi-Fi Paylaşımı', 'audio_trimmer': 'Ses Kırpıcı & Zil Sesi', 'calculator_disguise': 'Hesap Makinesi Gizlemesi', 'calculator_disguise_desc': 'PIN ile açılan gerçek hesap makinesi', 'subtitles': 'Altyazılar (SRT)', 'download_subtitles': 'Altyazıyı İndir', 'playlist': 'Oynatma Listesi', 'download_all_video': 'Tümünü Video Olarak İndir (MP4)', 'download_all_audio': 'Tümünü Ses Olarak İndir (MP3)', 'schedule_download': 'İndirmeyi Zamanla', 'quick_platforms': 'Hızlı Platformlar', 'clipboard_detected': 'Panoda bağlantı bulundu!', 'browser': 'Tarayıcı', 'biometric_auth': 'Biyometri', 'biometric_desc': 'Parmak izi veya yüz ile kilidi açın',
      'theme_station': 'Tema İstasyonu', 'theme_station_desc': 'Görünüm ve renkleri değiştirin',
      'data_usage': 'Veri Kullanımı', 'data_usage_desc': 'Trafik ve tasarrufu izleyin',
      'today_usage': 'Bugünkü Kullanım', 'total_usage': 'Toplam Kullanım', 'saved_data': 'Tasarruf Edilen',
      'decoy_pin': 'Sahte Kasa PIN (Decoy)', 'decoy_pin_desc': 'Zorlama anında sahte boş kasa açan alternatif PIN',
      'vault_settings': 'Kasa Güvenliği',
      'privacy_security': 'Gizlilik ve Güvenlik',
      'storage_maintenance': 'Depolama ve Bakım',
      'turbo_download': 'Turbo Çok Kanallı İndirme',
      'turbo_download_desc': 'Hızı en üst düzeye çıkarmak için eşzamanlı bağlantılar',
      'threads_count': 'Eşzamanlı İndirme Kanalları',
      'threads_desc': 'ultra hızlı indirme için paralel kanal',
      'download_path_title': 'Kayıt Yolu',
      'auto_retry_desc': 'Bağlantı kurulduğunda otomatik devam et',
      'clear_cache_title': 'Önbelleği ve Geçici Dosyaları Temizle',
      'clear_cache_desc': 'Yer açmak için tamamlanmamış parçaları (.part) silin',
      'web_share_desc': 'Dosyaları kablosuz doğrudan PC tarayıcısına aktarın',
      'change_vault_pin': 'Kasa PIN Kodunu Değiştir',
      'change_vault_pin_desc': 'Yeni bir güvenlik PIN kodu belirleyin',
      'biometric_title': 'Biyometrik Kilit Açma',
    ...
    final de = {
      ...
      'search': 'Suche', 'discover': 'Entdecken & Herunterladen', 'search_hint': 'Auf YouTube suchen...',
      'start_search': 'Finden Sie Videos und Audio in höchster Qualität',
      'download_btn': 'Herunterladen', 'related': 'Ähnliche Videos',
      'have_link': 'Haben Sie einen Link?', 'paste_here': 'Link hier einfügen zum Herunterladen',
      'downloading': 'Wird heruntergeladen...', 'completed': 'Download abgeschlossen',
      'formats_title': 'Qualität wählen', 'video': 'Videos', 'audio': 'Musik',
      'downloaded': 'Heruntergeladene Dateien', 'general': 'Allgemein', 'dl_settings': 'Download-Einstellungen',
      'notif': 'Benachrichtigungen', 'theme': 'Design', 'language': 'Sprache', 'more_tools': 'Weitere Werkzeuge',
      'share_app': 'App teilen', 'clean_cache': 'Cache leeren', 'about': 'Über die App',
      'no_audio': 'Keine Musik vorhanden', 'no_video': 'Keine Videos vorhanden',
      'downloading_now': 'Wird heruntergeladen:', 'file_not_found': 'Datei nicht gefunden',
      'no_results': 'Keine Ergebnisse 😔', 'search_error': 'Suchfehler.',
      'invalid_link': 'Ungültiger Link', 'extracting': 'Formate werden analysiert...',
      'share': 'Teilen', 'convert_to_mp3': 'In MP3 umwandeln', 'converting': 'Audio wird extrahiert...',
      'converted_success': 'Audio erfolgreich extrahiert!', 'convert_failed': 'Audioextraktion fehlgeschlagen', 'size': 'Größe',
      'vault': 'Privater Tresor', 'vault_desc': 'Dateien mit PIN-Code schützen',
      'set_pin': 'PIN festlegen', 'enter_pin': 'PIN eingeben',
      'pin_hint': '4-stelliger Code', 'pin_set_success': 'PIN erfolgreich festgelegt',
      'wrong_pin': 'Falsche PIN!', 'move_to_vault': 'Im Tresor sperren',
      'moved_to_vault_success': 'Datei in den Tresor verschoben 🔒',
      'restore_from_vault': 'Entsperren (Wiederherstellen)',
      'restored_success': 'Datei wiederhergestellt 🔓',
      'vault_empty': 'Tresor ist leer.',
      'wifi_only': 'Nur über WLAN laden', 'wifi_only_desc': 'Mobile Daten sparen',
      'wifi_warning': 'Download pausiert: Nur-WLAN aktiv',
      'auto_retry_active': 'Automatisches Fortsetzen aktiv', 'retrying_download': 'Wiederhole Download...',
      'web_share': 'WLAN-PC-Freigabe', 'audio_trimmer': 'Audio-Cutter & Klingelton', 'calculator_disguise': 'Taschenrechner-Tarnung', 'calculator_disguise_desc': 'Echter Rechner, per PIN entsperrt', 'subtitles': 'Untertitel (SRT)', 'download_subtitles': 'Untertitel laden', 'playlist': 'Wiedergabeliste', 'download_all_video': 'Alle als Video laden (MP4)', 'download_all_audio': 'Alle als Audio laden (MP3)', 'schedule_download': 'Download planen', 'quick_platforms': 'Schnellplattformen', 'clipboard_detected': 'Link in Zwischenablage erkannt!', 'browser': 'Browser', 'biometric_auth': 'Biometrie', 'biometric_desc': 'Tresor mit Fingerabdruck/Gesicht öffnen',
      'theme_station': 'Design-Station', 'theme_station_desc': 'Aussehen und Farben anpassen',
      'data_usage': 'Datennutzung', 'data_usage_desc': 'Verbrauch überwachen',
      'today_usage': 'Heute verbraucht', 'total_usage': 'Gesamtverbrauch', 'saved_data': 'Eingesparte Daten',
      'decoy_pin': 'Täuschungs-PIN (Decoy)', 'decoy_pin_desc': 'Alternativer Code, der einen leeren Scheintresor öffnet',
      'vault_settings': 'Tresorsicherheit',
      'privacy_security': 'Datenschutz & Sicherheit',
      'storage_maintenance': 'Speicher & Wartung',
      'turbo_download': 'Turbo-Multithreading-Download',
      'turbo_download_desc': 'Dateien über parallele Verbindungen laden für max. Speed',
      'threads_count': 'Parallele Download-Threads',
      'threads_desc': 'parallele Threads für ultraschnelles Laden',
      'download_path_title': 'Speicherpfad',
      'auto_retry_desc': 'Bei Wiederverbindung automatisch fortsetzen',
      'clear_cache_title': 'Cache & temporäre Dateien leeren',
      'clear_cache_desc': 'Unvollständige .part-Dateien löschen, um Platz freizugeben',
      'web_share_desc': 'Dateien kabellos direkt an PC-Browser übertragen',
      'change_vault_pin': 'Tresor-PIN ändern',
      'change_vault_pin_desc': 'Einen neuen Sicherheits-PIN-Code festlegen',
      'biometric_title': 'Biometrisches Entsperren',
    ...
    final ru = {
      ...
      'search': 'Поиск', 'discover': 'Обзор и загрузка', 'search_hint': 'Поиск на YouTube...',
      'start_search': 'Легко находите видео и аудио в высоком качестве',
      'download_btn': 'Скачать', 'related': 'Похожие видео',
      'have_link': 'Есть ссылка?', 'paste_here': 'Вставьте ссылку для скачивания',
      'downloading': 'Загрузка...', 'completed': 'Загрузка завершена',
      'formats_title': 'Выберите качество', 'video': 'Видео', 'audio': 'Музыка',
      'downloaded': 'Загруженные файлы', 'general': 'Общие', 'dl_settings': 'Настройки загрузки',
      'notif': 'Уведомления', 'theme': 'Тема', 'language': 'Язык', 'more_tools': 'Инструменты',
      'share_app': 'Поделиться приложением', 'clean_cache': 'Очистить кэш', 'about': 'О приложении',
      'no_audio': 'Музыка не загружена', 'no_video': 'Видео не загружены',
      'downloading_now': 'Загружается:', 'file_not_found': 'Файл не найден',
      'no_results': 'Ничего не найдено 😔', 'search_error': 'Ошибка поиска.',
      'invalid_link': 'Неверная ссылка', 'extracting': 'Извлечение форматов...',
      'share': 'Поделиться', 'convert_to_mp3': 'Конвертировать в MP3', 'converting': 'Извлечение аудио...',
      'converted_success': 'Аудио успешно извлечено!', 'convert_failed': 'Ошибка извлечения', 'size': 'Размер',
      'vault': 'Личный сейф', 'vault_desc': 'Защита медиафайлов PIN-кодом',
      'set_pin': 'Установить PIN', 'enter_pin': 'Введите PIN-код',
      'pin_hint': '4-значный код', 'pin_set_success': 'PIN успешно установлен',
      'wrong_pin': 'Неверный PIN!', 'move_to_vault': 'Заблокировать в сейфе',
      'moved_to_vault_success': 'Файл перемещен в сейф 🔒',
      'restore_from_vault': 'Разблокировать (Вернуть в загрузки)',
      'restored_success': 'Файл восстановлен 🔓',
      'vault_empty': 'Сейф пуст.',
      'wifi_only': 'Загрузка только по Wi-Fi', 'wifi_only_desc': 'Экономия мобильного интернета',
      'wifi_warning': 'Загрузка на паузе: Включен режим только Wi-Fi',
      'auto_retry_active': 'Авто-возобновление активно', 'retrying_download': 'Повторная попытка...',
      'web_share': 'Раздача на ПК по Wi-Fi', 'audio_trimmer': 'Обрезка аудио и рингтоны', 'calculator_disguise': 'Маскировка под калькулятор', 'calculator_disguise_desc': 'Настоящий калькулятор, открывающий сейф по PIN', 'subtitles': 'Субтитры (SRT)', 'download_subtitles': 'Скачать субтитры', 'playlist': 'Плейлист', 'download_all_video': 'Скачать все как видео (MP4)', 'download_all_audio': 'Скачать все как аудио (MP3)', 'schedule_download': 'Отложенная загрузка', 'quick_platforms': 'Быстрые платформы', 'clipboard_detected': 'В буфере обнаружена ссылка!', 'browser': 'Браузер', 'biometric_auth': 'Биометрия', 'biometric_desc': 'Отпечаток пальца или лицо для сейфа',
      'theme_station': 'Станция тем', 'theme_station_desc': 'Выбор оформления и цветов',
      'data_usage': 'Статистика трафика', 'data_usage_desc': 'Контроль расхода и экономия',
      'today_usage': 'Расход за сегодня', 'total_usage': 'Общий расход', 'saved_data': 'Сэкономлено данных',
      'decoy_pin': 'Фальшивый PIN (Decoy)', 'decoy_pin_desc': 'Код, открывающий пустой сейф-обманку при принуждении',
      'vault_settings': 'Безопасность сейфа',
      'privacy_security': 'Конфиденциальность и безопасность',
      'storage_maintenance': 'Память и обслуживание',
      'turbo_download': 'Турбо-многопоточная загрузка',
      'turbo_download_desc': 'Загрузка в несколько параллельных потоков для макс. скорости',
      'threads_count': 'Количество параллельных потоков',
      'threads_desc': 'потоков для сверхбыстрой загрузки',
      'download_path_title': 'Путь сохранения',
      'auto_retry_desc': 'Автоматическое продолжение при восстановлении связи',
      'clear_cache_title': 'Очистка кэша и временных файлов',
      'clear_cache_desc': 'Удаление незавершенных фрагментов (.part) для освобождения памяти',
      'web_share_desc': 'Передача файлов прямо на ПК через браузер без кабеля',
      'change_vault_pin': 'Сменить PIN сейфа',
      'change_vault_pin_desc': 'Установить новый секретный код доступа',
      'biometric_title': 'Биометрическая разблокировка',
    ...
    if (currentLang == 'en') return en[key] ?? key;
    if (currentLang == 'fr') return fr[key] ?? key;
    if (currentLang == 'es') return es[key] ?? key;
    if (currentLang == 'tr') return tr[key] ?? key;
    if (currentLang == 'de') return de[key] ?? key;
    ...
    try {
      if (!needsMerge) {
        ...
        if (ext == 'mp3') {
          ...
          onStatusChanged('جاري معالجة وتجهيز ملف MP3 عبر FFmpeg...');
          ...
          try {
            ...
            if (ReturnCode.isSuccess(returnCode) && await File(tempMp3Path).exists() && await File(tempMp3Path).length() > 0) {
            ...
            debugPrint("استثناء أثناء تحويل MP3 عبر FFmpeg: $e");
          }
        ...
        if (audioSize > 1024 && await vSourceFile.exists()) {
          ...
          for (final attempt in ffmpegAttempts) {
            ...
            try {
              ...
              if (ReturnCode.isSuccess(returnCode) && fileExists && mergedLength > (vSourceSize * 0.7)) {
                ...
                debugPrint("تم الدمج الصوتي بنجاح تام عبر FFmpeg! الحجم: $mergedLength بايت");
                break;
              } else {
          ...
          // محاولة احتياطية إضافية عبر MediaMuxer إذا لزم الأمر
          if (!mergeSucceeded) {
            try {
              debugPrint("محاولة دمج احتياطية عبر MediaMuxer...");
              ...
              if (res == true && fileExists && mergedLength > (vSourceSize * 0.7)) {
                ...
                debugPrint("تم الدمج الاحتياطي عبر MediaMuxer بنجاح!");
              }
            } catch (e) {
              debugPrint("خطأ في محاولة MediaMuxer الاحتياطية: $e");
            }
          }
        } else {
        ...
        if (mergeSucceeded && await File(successfulMergedPath).exists()) {
          ...
          debugPrint('تحذير: تعذر دمج الصوت عبر FFmpeg/MediaMuxer. حفظ ملف الفيديو المتاح.');
  ...
  Future<bool> convertVideoToMp3({
    ...
    try {
      ...
      // محاولة 1: التحويل عبر FFmpeg إلى MP3 بجودة 192k
      ...
      if (ReturnCode.isSuccess(returnCode) && await File(outputMp3Path).exists()) {
        onStatus(t('converted_success'));
        return true;
      }

      // محاولة 2: عبر ترميز AAC داخل M4A
      String outputM4aPath = '${downloadsDir.path}/${nameWithoutExt}_audio.m4a';
      ...
      if (ReturnCode.isSuccess(returnCode) && await File(outputM4aPath).exists()) {
        onStatus(t('converted_success'));
        return true;
      }

      // محاولة احتياطية عبر MediaMuxer
      const muxerChannel = MethodChannel('com.boykta.app/media_muxer');
      ...
      if (res == true && await File(outputM4aPath).exists()) {
        onStatus(t('converted_success'));
        return true;
      } else {
